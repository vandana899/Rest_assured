...
public class class2 {
	...
	public void tc1() {                //for creating and deleting 
	  ...
	  id= jp.get("id");
		...
		given().queryParam("name", "shizuka2").queryParam("key", "d48e2454df1464817d76399ef898c28c").queryParam("token", "bd0e9c156c00d694c5a295c6ffb243f90a27283714cf49e5e824e8ed8f75fda9").when().accept(ContentType.JSON).contentType(ContentType.JSON).delete("/1/boards/"+id).then().log().all();
}
}